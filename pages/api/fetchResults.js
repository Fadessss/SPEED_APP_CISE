...
export default async (req, res) => {
    ...
    try {
        const results = await SEPractice.find({ SEPractice: topic, claim: claim },"title authors yearOfPublication journalOrConferenceName SEPractice claim resultOfEvidence typeOfResearch typeOfParticipant"); 
