...
const ResultHeader = ({ sortConfig, setSortConfig }) => {
  ...
  return (
    <tr className={styles.tableRow}>
          ...
          <th className={sortConfig.key === "yearOfPublication" ? styles.columnSort + " " + styles[sortConfig.direction] : styles.columnSort} onClick={() => setSortConfig({ key: 'yearOfPublication', direction: sortConfig.direction === 'ascending' ? 'descending' : 'ascending' })}>Year</th>
          <th className={sortConfig.key === "journalOrConferenceName" ? styles.columnSort + " " + styles[sortConfig.direction] : styles.columnSort} onClick={() => setSortConfig({ key: 'journalOrConferenceName', direction: sortConfig.direction === 'ascending' ? 'descending' : 'ascending' })}>Journal</th>
          ...
          <th className={sortConfig.key === "resultOfEvidence" ? styles.columnSort + " " + styles[sortConfig.direction] : styles.columnSort} onClick={() => setSortConfig({ key: 'resultOfEvidence', direction: sortConfig.direction === 'ascending' ? 'descending' : 'ascending' })}>Result</th>
          <th className={sortConfig.key === "typeOfResearch" ? styles.columnSort + " " + styles[sortConfig.direction] : styles.columnSort} onClick={() => setSortConfig({ key: 'typeOfResearch', direction: sortConfig.direction === 'ascending' ? 'descending' : 'ascending' })}>Research</th>
          <th className={sortConfig.key === "typeOfParticipant" ? styles.columnSort + " " + styles[sortConfig.direction] : styles.columnSort} onClick={() => setSortConfig({ key: 'typeOfParticipant', direction: sortConfig.direction === 'ascending' ? 'descending' : 'ascending' })}>Participant</th>
