  ...
  return (
    ...
    showPopup ? (
        ...
        <div className={styles.popup}>
          ...
          <h2>{selectedResult.title} - {selectedResult.yearOfPublication} - {selectedResult.authors}</h2>
          {/* A summary paragraph which prints out details about the selectedResult. */}
          <p>This is the summary. It provides a brief summary of the data related to the claim within the journal article.
            <br /><br />
            {/* An example sentence displaying usage of the selected result's properties. */}
            Eg. {selectedResult.title} demonstrates evidence which {selectedResult.resultOfEvidence}s that {selectedResult.SEPractice} {selectedResult.claim}.
            <br /><br />
            {/* Additional details about the selectedResult. */}
            The article was written by {selectedResult.authors} in {selectedResult.yearOfPublication}, and was published in {selectedResult.journalOrConferenceName}.
          </p>
